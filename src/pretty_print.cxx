...
size_t print_data_width = 5;
int print_data_precision = 1;
...
void add_letter(std::vector<std::string>& lines, const int letter) {
...
void add_header_indices(const Dimensions& dimensions, std::vector<std::string>& header) {
...
void output_234(const Tensor& tensor, const Dimensions& dimensions, std::ostream& stream) {
...
void set_print_data_width(const int width) {
    // sets the width of the data elements when pretty printing
    impl::print_data_width = width;
}

void set_print_precision(const int precision) {
...
std::ostream& pretty_print(std::ostream& ostream, const Tensor& tensor) {
...
std::ostream& operator<<(std::ostream& stream, const varitensor::Tensor& tensor) {
